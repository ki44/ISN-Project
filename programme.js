function main(){
    ...
    var shoots = [];
	var speed_norme = 7.5;		// vitesse des balles
    var mob = [];
	var a = 1500;
    var mob_health = 2;
	var sl= 0;
    ...
    function background(){
		...
		ctx.rect(character.x + character.size + 10, character.y + character.size +10, -gun.delay_recharge*(character.size + 20)/125, 3.5);
		for(var m=0; m <= mob.length - 1; m++){
